...
namespace service_system
{
    namespace publisher
    {
        ...
        const std::string &Publisher::getName() const { return name; }
        const std::string &Publisher::getLocation() const { return "publihser service"; }
        const std::string &Publisher::getDescription() const { return "used for notification"; }
        void Publisher::notify(const std::string &e, std::shared_ptr<abstract::data::InputData> d){
            //to do
        }
    ...
    namespace tokenizer
    {
        ...
        const std::string &Tokenizer::getLocation() const { return "tokenizer service"; }
        const std::string &Tokenizer::getDescription() const { return "used for tokenization"; }
